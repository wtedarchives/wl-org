...
export const GORPS_INTRO = {
  title:
    "Goose Obsessed Radio Personalities (GORPs) & Station Contributors",
  communityUrl: "https://community.WysteriaLane.org/",
...
export const GORPS_ENTRIES: GorpEntry[] = [
  {
    ...
    bio: [
      "Michael is an active Goose Jockey and the WTED Program Director, contributing to show analysis on WTED Radio as well as moderating the Wysteria Lane Community site. He resides in Oregon but still has Michigan close to his heart. When not working on the WTED Radio station, he enjoys live music (shocker), water sports, cycling, and golf.",
    ],
    bullets: [
      "Formerly Incarcerated #criminaljusticereform",
      "Friend of Bill W.",
      "B4L",
      "The Greatest Radio Program Director Who Has Ever Lived",
      "Supreme Show Buddy",
    ],
    quote:
  ...
  },
  {
    ...
    bio: [
      'Kyle lives in Bedford, TX (a suburb of Dallas/Fort Worth) with his wife since 2009 and his daughter, their only child, born in 2015. He once wrote, in as brief a way possible, about their lives and relationship with the band for the El Goose Times, featured in the STTF/EGT collaboration issue. Kyle also hosts his primary Goose blog space at <a href="https://WysteriaLane.org" target="_blank" rel="noopener noreferrer" class="font-medium text-wl-orange underline hover:text-wl-light-orange">WysteriaLane.org</a>.',
      "He has been the face behind the Wysteria Lane account on many of the internet platforms we all frequent, where he admits to inevitably searching for that feeling of community that never seemed to grasp his true spirit so much as it has at the Wysteria Lane Community. Thus, he says, is why he created it, not only for selfish reasons, but for the community at large (so all of this is really his fault). If you can't find him there, you'll find him doing one of a variety of things with his family: assisting at his daughter's soccer practice, on a date with his wife, on a random weekend family fun outing with their 21' Featherlite trailer in tow, at a Dallas Stars hockey game, or in their family-sized 14' tandem kayak in various small bodies of water surrounding the greater DFW area.",
    ],
    quote:
  ...
  },
  {
    ...
    bio: [
      ...
      "Corey lives in Milwaukee, Wisconsin (site of your 2025 JOTY) with his wife (who is an immeasurably better person than he is) and a jerk cat. He enjoys travel (especially for live music), using too many parentheses, proselytizing the good news of Central Texas style barbecue, and the bar he was legally required to build in his basement.",
    ],
    quote:
