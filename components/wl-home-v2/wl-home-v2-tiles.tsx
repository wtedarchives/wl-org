    ...
    <section className="grid" id="tileGrid">
      ...
      >
        ...
        <div className="tile-widget">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            Community Events <span className="arr">→</span>
          </a>
        </div>
      ...
      >
        ...
        <div className="tile-widget">
          ...
          <Link className="wbtn" href="/wted/shows">
            Next Show <span className="arr">→</span>
          </Link>
        </div>
