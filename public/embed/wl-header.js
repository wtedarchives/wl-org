...
(function () {
  ...
  var STYLES = [
    ...
    ".brand-text .wl { font-weight: 700; letter-spacing: -0.01em; font-size: 15px; color: #000000; }",
    '.brand-text .dotorg { font-family: "Geist Mono", ui-monospace, monospace; font-size: 10px; color: #000000; margin-top: 3px; letter-spacing: 0.04em; }',
