...
export const SETLISTER_RULES: Record<string, SetlisterRule> = {
  ...
  // ─── Live-show posting ────────────────────────────────────────────────────
  // These publish to Discourse chat, push notifications, Bluesky and Instagram.
  // Scoped to the assigned show and inside the window, which is what makes them
  // safe to delegate: a setlister can only announce the show they are working.
